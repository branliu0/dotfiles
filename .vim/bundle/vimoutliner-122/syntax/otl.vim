...
" New colors based on jellybeans.vim
if g:otl_bold_headers
  hi def otlTab0 ctermfg=1 cterm=bold gui=bold guifg=#fad07a term=reverse
  hi def otlTab1 ctermfg=4 cterm=bold gui=bold guifg=#c6b6ee term=reverse
  hi def otlTab2 ctermfg=2 cterm=bold gui=bold guifg=#7697d6 term=reverse
  ...
  hi def otlTab0 ctermfg=1 cterm=NONE guifg=#fad07a
  hi def otlTab1 ctermfg=4 cterm=NONE guifg=#c6b6ee
  hi def otlTab2 ctermfg=2 cterm=NONE guifg=#7697d6
